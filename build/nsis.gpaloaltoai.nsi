...
# 1. install gpaa for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gpaa
# 5. create gpaa, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable PaloAltoAi_SOCKET
...
!define GROUPNAME "PaloAltoAi"
!define APPNAME "Gpaa"
!define DESCRIPTION "Official Go implementation of the PaloAltoAi protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gpaa is installed global
