...
//
// paa_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// paa_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.PaaSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "paa_getBlockByNumber", "latest"); err != nil {
