...
// Whisper represents a dark communication interface through the PaloAltoAi
...
// New creates a Whisper client ready to communicate through the PaloAltoAi P2P network.
...
// param isP2P indicates whpaaer the message is peer-to-peer (should not be forwarded).
