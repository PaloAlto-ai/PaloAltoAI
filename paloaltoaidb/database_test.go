...
func newTestLDB() (*paadb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "paadb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := paadb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(paadb.NewMemDatabase(), t)
}

func testPutGet(db paadb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(paadb.NewMemDatabase(), t)
}

func testParallelPutGet(db paadb.Database, t *testing.T) {
	const n = 8
