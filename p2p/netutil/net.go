...
// Contains reports whpaaer the given IP is contained in the list.
...
// IsLAN reports whpaaer an IP is a local network address.
...
// IsSpecialNetwork reports whpaaer an IP is located in a special-use network range
...
// CheckRelayIP reports whpaaer an IP relayed from the given sender IP
...
// SameNet reports whpaaer two IP addresses have an equal prefix of the given bit length.
...
// Contains whpaaer the given IP is contained in the set.
