...
// Package enr implements PaloAltoAi Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whpaaer the record is signed using the given identity scheme.
