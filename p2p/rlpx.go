...
import (
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/crypto/secp256k1"
...
// and also verifies whpaaer the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whpaaer read packet had plain format.
