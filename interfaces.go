...
// Package PaloAltoAi defines interfaces for interacting with PaloAltoAi.
package PaloAltoAi
...
type TransactionReader interface {
	...
	// blockchain. The isPending return value indicates whpaaer the transaction has been
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by paa_getLogs, return logs only from block with this hash
