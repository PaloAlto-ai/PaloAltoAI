...
// PeerInfo represents a short summary of the PaloAltoAi sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // PaloAltoAi protocol version negotiated
...
// Handshake executes the paa protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("paa/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the PaloAltoAi sub-protocol.
type peerSet struct {
