...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (paa/61) or header (paa/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (paa/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both paa/61 and paa/62)
}
...
func (f *Fetcher) insert(peer string, block *types.Block) {
	...
	go func() {
		...
		default:
			// Sompaaing went very wrong, drop the peer
