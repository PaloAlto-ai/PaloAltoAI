...
type downloadTester struct {
	...
	stateDb paadb.Database // Database used by the tester for syncing from peers
	peerDb  paadb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb = paadb.NewMemDatabase()
...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", PaloAltoAi.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", PaloAltoAi.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", PaloAltoAi.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", PaloAltoAi.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want PaloAltoAi.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", PaloAltoAi.SyncProgress{
