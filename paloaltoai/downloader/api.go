...
// Syncing provides information when this nodes starts synchronising with the PaloAltoAi network and when it's finished.
...
type SyncingResult struct {
	...
	Status  PaloAltoAi.SyncProgress `json:"status"`
}
