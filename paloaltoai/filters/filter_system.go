...
// Package filters implements an PaloAltoAi filtering system for block,
...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  PaloAltoAi.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) SubscribeLogs(crit PaloAltoAi.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeMinedPendingLogs(crit PaloAltoAi.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit PaloAltoAi.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit PaloAltoAi.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
