...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllPaaashProtocolChanges, new: AllPaaashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllPaaashProtocolChanges, new: AllPaaashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllPaaashProtocolChanges,
