...
type request struct {
	...
	raw  bool        // Whpaaer this is a raw entry (code) or a trie node
...
func (s *Sync) AddSubTrie(root common.Hash, depth int, parent common.Hash, callback LeafCallback) {
	...
	// If this sub-trie has a designated parent, link them togpaaer
...
// Process injects a batch of retrieved trie nodes data, returning if sompaaing
...
func (s *Sync) Commit(dbw paadb.Putter) (int, error) {
...
func (s *Sync) children(req *request, object node) ([]*request, error) {
	// Gather all the children of the node, irrelevant whpaaer known or not
	type child struct {
		node  node
		depth int
	}
