...
type DatabaseReader interface {
	...
	// Has retrieves whpaaer a key is present in the database.
...
type Database struct {
	diskdb paadb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb paadb.Database) *Database {
...
func NewDatabaseWithCache(diskdb paadb.Database, cache int) *Database {
...
func (db *Database) commit(hash common.Hash, batch paadb.Batch) error {
...
// memory and check whpaaer every node is reachable from the meta root. The goal
