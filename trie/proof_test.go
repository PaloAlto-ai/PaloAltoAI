...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *paadb.MemDatabase {
	var provers []func(key []byte) *paadb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *paadb.MemDatabase {
		proof := paadb.NewMemDatabase()
