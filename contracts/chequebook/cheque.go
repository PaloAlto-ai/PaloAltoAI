...
// Package chequebook package wraps the 'chequebook' PaloAltoAi smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in paaer; (auto)cashing cheques in paaer
// as well as (auto)depositing paaer to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/contracts/chequebook/contract"
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/services/swap/swap"
)
...
// * depositing paaer to the chequebook
// * watching incoming paaer
...
// Cash cashes the cheque by sending an PaloAltoAi transaction.
