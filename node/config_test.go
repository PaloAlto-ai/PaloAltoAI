...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gpaa.ipc", false, filepath.Join(os.TempDir(), "gpaa.ipc")},
		{"data", "gpaa.ipc", false, "data/gpaa.ipc"},
		{"data", "./gpaa.ipc", false, "./gpaa.ipc"},
		{"data", "/gpaa.ipc", false, "/gpaa.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gpaa.ipc", true, `\\.\pipe\gpaa.ipc`},
		{"data", "gpaa.ipc", true, `\\.\pipe\gpaa.ipc`},
		{"data", `\\.\pipe\gpaa.ipc`, true, `\\.\pipe\gpaa.ipc`},
	}
