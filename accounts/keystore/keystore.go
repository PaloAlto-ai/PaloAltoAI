...
// See https://github.com/PaloAltoAi/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whpaaer the event notification loop is running
...
// HasAddress reports whpaaer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given PaloAltoAi presale wallet and stores
