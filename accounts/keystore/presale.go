...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/PaloAltoAi/pypaasaletool

		pypaasaletool generates the encryption key from password by
	...
	*/
	...
	paaPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(paaPriv)
	...
	expectedAddr := preSaleKeyStruct.PaaAddr
