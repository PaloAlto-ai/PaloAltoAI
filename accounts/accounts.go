...
// Package accounts implements high level PaloAltoAi account management.
package accounts
...
// Account represents an PaloAltoAi account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // PaloAltoAi account address derived from the key
...
type Wallet interface {
	...
	// Contains returns whpaaer an account is part of this particular wallet or not.
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain PaloAltoAi.ChainStateReader)
