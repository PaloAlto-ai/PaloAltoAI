...
// Package bind generates PaloAltoAi contract Go bindings.
//
// Detailed usage document and tutorial available on the go-PaloAltoAi Wiki page:
// https://github.com/PaloAltoAi/go-PaloAltoAi/wiki/Native-DApps:-Go-bindings-to-PaloAltoAi-contracts
package bind
...
// structured checks whpaaer a list of ABI data types has enough information to
