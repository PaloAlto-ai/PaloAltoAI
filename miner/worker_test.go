...
var (
	...
	paaashChainConfig *params.ChainConfig
...
func init() {
	...
	paaashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setPaaerbase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockPaaash(t *testing.T) {
	testPendingStateAndBlock(t, paaashChainConfig, paaash.NewFaker())
}
func TestPendingStateAndBlockClique(t *testing.T) {
	testPendingStateAndBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, paadb.NewMemDatabase()))
}
...
func TestEmptyWorkPaaash(t *testing.T) {
	testEmptyWork(t, paaashChainConfig, paaash.NewFaker())
}
func TestEmptyWorkClique(t *testing.T) {
	testEmptyWork(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, paadb.NewMemDatabase()))
}
...
func TestStreamUncleBlock(t *testing.T) {
	paaash := paaash.NewFaker()
	defer paaash.Close()

	w, b := newTestWorker(t, paaashChainConfig, paaash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockPaaash(t *testing.T) {
	testRegenerateMiningBlock(t, paaashChainConfig, paaash.NewFaker())
}

func TestRegenerateMiningBlockClique(t *testing.T) {
	testRegenerateMiningBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, paadb.NewMemDatabase()))
}
...
func TestAdjustIntervalPaaash(t *testing.T) {
	testAdjustInterval(t, paaashChainConfig, paaash.NewFaker())
}

func TestAdjustIntervalClique(t *testing.T) {
	testAdjustInterval(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, paadb.NewMemDatabase()))
}
