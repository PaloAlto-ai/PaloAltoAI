...
// mapped from textual names used in the tests below to actual PaloAltoAi private
...
// address retrieves the PaloAltoAi address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the PaloAltoAi address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/PaloAltoAi/go-PaloAltoAi/issues/17593). Whilst this
	...
	for i, tt := range tests {
		...
		for j, block := range blocks {
			// Gpaa the header and prepare it for signing
			header := block.Header()
			if j > 0 {
