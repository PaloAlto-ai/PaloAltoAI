...
var (
	...
	// errInvalidVote is returned if a nonce value is sompaaing else that the two
...
// ecrecover extracts the PaloAltoAi account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the PaloAltoAi address
...
// PaloAltoAi testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     paadb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // PaloAltoAi address of the signing key
...
func New(config *params.CliqueConfig, db paadb.Database) *Clique {
...
// Author implements consensus.Engine, returning the PaloAltoAi address recovered
// from the signature in the header's extra-data section.
func (c *Clique) Author(header *types.Header) (common.Address, error) {
	return ecrecover(header, c.signatures)
}

// VerifyHeader checks whpaaer a header conforms to the consensus rules.
...
// verifyHeader checks whpaaer a header conforms to the consensus rules.The
...
// VerifySeal implements consensus.Engine, checking whpaaer the signature contained
// in the header satisfies the consensus protocol requirements.
func (c *Clique) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
	return c.verifySeal(chain, header, nil)
}

// verifySeal checks whpaaer the signature contained in the header satisfies the
