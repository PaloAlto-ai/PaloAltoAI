...
// Contains a wrapper for the PaloAltoAi client.
...
// PaloAltoAiClient provides access to the PaloAltoAi APIs.
type PaloAltoAiClient struct {
	client *paaclient.Client
}

// NewPaloAltoAiClient connects a client to the given URL.
func NewPaloAltoAiClient(rawurl string) (client *PaloAltoAiClient, _ error) {
	rawClient, err := paaclient.Dial(rawurl)
	return &PaloAltoAiClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *PaloAltoAiClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *PaloAltoAiClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *PaloAltoAiClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *PaloAltoAiClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *PaloAltoAiClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *PaloAltoAiClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *PaloAltoAiClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *PaloAltoAiClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *PaloAltoAiClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *PaloAltoAiClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *PaloAltoAiClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *PaloAltoAiClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *PaloAltoAiClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *PaloAltoAiClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *PaloAltoAiClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *PaloAltoAiClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *PaloAltoAiClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *PaloAltoAiClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *PaloAltoAiClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *PaloAltoAiClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *PaloAltoAiClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *PaloAltoAiClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *PaloAltoAiClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *PaloAltoAiClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *PaloAltoAiClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *PaloAltoAiClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *PaloAltoAiClient) SendTransaction(ctx *Context, tx *Transaction) error {
