...
// to the PAA network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whpaaer a transaction is valid according to the consensus rules.
