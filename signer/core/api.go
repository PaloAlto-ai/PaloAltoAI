...
import (
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/accounts/usbwallet"
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*paaapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx paaapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*paaapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := paaapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
