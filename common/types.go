...
// Address represents the 20 byte address of an PaloAltoAi account.
...
// IsHexAddress verifies whpaaer a string can represent a valid hex-encoded
// PaloAltoAi address or not.
