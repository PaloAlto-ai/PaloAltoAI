...
type GlogHandler struct {
	...
	override  uint32 // Flag whpaaer overrides are used, atomically accessible
	backtrace uint32 // Flag whpaaer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whpaaer this is the callsite
