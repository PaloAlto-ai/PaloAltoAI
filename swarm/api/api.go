...
import (
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/spancontext"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/storage"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/storage/feed"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/storage/feed/lookup"
...
it is the public interface of the FileStore which is included in the PaloAltoAi stack
*/
type API struct {
	feed      *feed.Handler
...
// ErrNotAFeedManifest is returned when the address provided returned sompaaing other than a valid manifest
