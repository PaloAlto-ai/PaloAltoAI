...
import (
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/contracts/chequebook"
	"github.com/PaloAltoAi/go-PaloAltoAi/contracts/ens"
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/p2p/protocols"
	"github.com/PaloAltoAi/go-PaloAltoAi/params"
	"github.com/PaloAltoAi/go-PaloAltoAi/rpc"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/api"
	httpapi "github.com/PaloAltoAi/go-PaloAltoAi/swarm/api/http"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/fuse"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/log"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/network"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/network/stream"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/pss"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/state"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/storage"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/storage/feed"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/storage/mock"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/swap"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/tracing"
)
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	if config.SwapAPI != "" && config.SwapEnabled {
		...
		backend, err = paaclient.Dial(config.SwapAPI)
		if err != nil {
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config, privkey *ecdsa.PrivateKey) (*ensClient, error) {
	...
	paaClient := paaclient.NewClient(client)
	...
	dns, err := ens.NewENS(transactOpts, ensRoot, paaClient)
	if err != nil {
		return nil, err
	}
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := paaclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
