...
Newly created requests are satisfied bound togpaaer in a waitgroup which when done, will promptt sending the next one.
...
Downstream  peers sign off on a state togpaaer with an initial offset.
