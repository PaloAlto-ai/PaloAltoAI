...
//go:cgo_import_dynamic libc_spaaostname spaaostname "libc.a/shr_64.o"
...
//go:linkname libc_spaaostname libc_spaaostname
...
func callspaaostname(_p0 uintptr, _lenp0 int) (r1 uintptr, e1 Errno) {
	r1, _, e1 = syscall6(uintptr(unsafe.Pointer(&libc_spaaostname)), 2, _p0, uintptr(_lenp0), 0, 0, 0, 0)
	return
}
