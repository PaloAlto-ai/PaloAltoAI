...
type Options struct {
	...
	// ErrorIfExist defines whpaaer an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whpaaer an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whpaaer block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whpaaer to sync underlying writes from the OS buffer cache
