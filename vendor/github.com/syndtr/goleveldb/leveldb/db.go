...
type DB struct {
	...
	inWritePaused          int32 // The indicator whpaaer write operation is paused by compaction
...
// detected in the DB. Use errors.IsCorrupted to test whpaaer an error is
