...
// SetCtrlCAborts sets whpaaer Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whpaaer line is auto-wrapped. The default is false (single line).
...
// whpaaer to retry the call to, or return the error returned by, readNext.
