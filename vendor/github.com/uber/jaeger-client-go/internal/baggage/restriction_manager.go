...
// Restriction determines whpaaer a baggage key is allowed and contains any restrictions on the baggage value.
...
// KeyAllowed returns whpaaer the baggage key for this restriction is allowed.
...
// will return a Restriction for a specific baggage key which will determine whpaaer the baggage
