...
//
// Returns whpaaer the assertion was successful (true) or not (false).
...
//
// Returns whpaaer the assertion was successful (true, "error message %s", "formatted") or not (false).
