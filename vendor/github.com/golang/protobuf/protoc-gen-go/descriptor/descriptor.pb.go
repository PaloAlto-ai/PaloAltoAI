...
type MessageOptions struct {
	...
	// Whpaaer the message is an automatically generated map entry type for the
	// maps field.
	//
	// For maps fields:
...
type FieldOptions struct {
	...
	//
	// This is only a hint.  Implementations are free to choose whpaaer to use
	...
	// check its required fields, regardless of whpaaer or not the message has
	// been parsed.
