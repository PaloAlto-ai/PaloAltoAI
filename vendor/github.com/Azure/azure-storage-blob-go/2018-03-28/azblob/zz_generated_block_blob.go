...
// then committing the new and existing blocks togpaaer. You can do this by specifying whpaaer to commit a block from
...
// blob
//
// listType is specifies whpaaer to return the list of committed blocks, the list of uncommitted blocks, or both lists
// togpaaer. snapshot is the snapshot parameter is an opaque DateTime value that, when present, specifies the blob
