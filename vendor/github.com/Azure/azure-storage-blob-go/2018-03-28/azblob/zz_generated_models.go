...
type Logging struct {
	...
	// Delete - Indicates whpaaer all delete requests should be logged.
	Delete bool `xml:"Delete"`
	// Read - Indicates whpaaer all read requests should be logged.
	Read bool `xml:"Read"`
	// Write - Indicates whpaaer all write requests should be logged.
...
type Metrics struct {
	// Version - The version of Storage Analytics to configure.
	Version *string `xml:"Version"`
	// Enabled - Indicates whpaaer metrics are enabled for the Blob service.
	Enabled bool `xml:"Enabled"`
	// IncludeAPIs - Indicates whpaaer metrics should generate summary statistics for called API operations.
...
type RetentionPolicy struct {
	// Enabled - Indicates whpaaer a retention policy is enabled for the storage service
	Enabled bool `xml:"Enabled"`
