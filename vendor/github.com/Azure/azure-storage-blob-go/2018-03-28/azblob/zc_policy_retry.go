...
type RetryOptions struct {
	...
	// starting point may be sompaaing like (60 seconds per MB of anticipated-payload-size).
	...
	// RetryReadsFromSecondaryHost specifies whpaaer the retry policy should retry a read operation against another host.
