...
// Condition have flag EastAsianWidth whpaaer the current locale is CJK or not.
...
// IsAmbiguousWidth returns whpaaer is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whpaaer is neutral width or not.
