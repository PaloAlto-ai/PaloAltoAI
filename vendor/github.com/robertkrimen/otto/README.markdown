...
Go translates JavaScript-style regular expressions into sompaaing that is
...
difficult to provide sompaaing like these via Go, but you probably want to wrap
