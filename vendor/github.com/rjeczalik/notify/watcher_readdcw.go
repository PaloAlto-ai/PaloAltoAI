...
// in order to distinguish whpaaer current folder should be re-registered in
...
// watched is made in order to check whpaaer an action comes from a directory or
...
// gensys decides whpaaer the Windows action, system-independent event or both
