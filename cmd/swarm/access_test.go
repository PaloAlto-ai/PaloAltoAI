...
import (
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/crypto/ecies"
	"github.com/PaloAltoAi/go-PaloAltoAi/log"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/api"
	swarmapi "github.com/PaloAltoAi/go-PaloAltoAi/swarm/api/client"
...
func testPassword(t *testing.T) {
	...
	if authHeader == "" {
		t.Fatal("should be sompaaing here")
	}
...
// the specs at https://github.com/paaersphere/swarm-docs/blob/eb857afda906c6e7bb90d37f3f334ccce5eef230/act.md
