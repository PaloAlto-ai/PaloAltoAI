...
import (
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm"
	bzzapi "github.com/PaloAltoAi/go-PaloAltoAi/swarm/api"
	swarmmetrics "github.com/PaloAltoAi/go-PaloAltoAi/swarm/metrics"
	"github.com/PaloAltoAi/go-PaloAltoAi/swarm/storage/mock"
	mockrpc "github.com/PaloAltoAi/go-PaloAltoAi/swarm/storage/mock/rpc"
...
// This init function sets defaults so cmd/swarm can run alongside gpaa.
func init() {
...
var app = utils.NewApp("", "PaloAltoAi Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-PaloAltoAi Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//gpaa only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gpaa and swarm
	...
	//register BZZ as node.Service in the PaloAltoAi node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the PaloAltoAi node
