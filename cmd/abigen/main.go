...
import (
	...
	"github.com/PaloAltoAi/go-PaloAltoAi/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the PaloAltoAi contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the PaloAltoAi contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the PaloAltoAi contract Solidity source to build and bind")
