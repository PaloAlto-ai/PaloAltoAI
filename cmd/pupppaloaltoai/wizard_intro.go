...
// makeWizard creates and returns a new pupppaa wizard.
...
// setting up a new or managing an existing PaloAltoAi private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to pupppaa, your PaloAltoAi private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new PaloAltoAi network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and paastats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Pupppaa uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering PaloAltoAi network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".pupppaa", w.network)
