...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(paadb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db paadb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db paadb.Database, root common.Hash) error {
...
func checkStateConsistency(db paadb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, paadb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(paadb.Database), srcRoot)
