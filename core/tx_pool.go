...
type TxPoolConfig struct {
	...
	NoLocals  bool             // Whpaaer local transaction handling should be disabled
...
// validateTx checks whpaaer a transaction is valid according to the consensus
...
// and returns whpaaer it was inserted or an older was better.
//
// Note, this method assumes the pool lock is held!
...
func (pool *TxPool) addTxsLocked(txs []*types.Transaction, local bool) []error {
	...
	// Only reprocess the internal state if sompaaing was actually added
	if len(dirty) > 0 {
