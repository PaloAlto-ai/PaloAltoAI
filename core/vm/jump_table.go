...
type operation struct {
	...
	halts   bool // indicates whpaaer the operation should halt further execution
	jumps   bool // indicates whpaaer the program counter should not increment
	writes  bool // determines whpaaer this a state modifying operation
	valid   bool // indication whpaaer the retrieved operation is valid and known
	reverts bool // determines whpaaer the operation reverts state (implicitly halts)
	returns bool // determines whpaaer the operations sets the return data content
}
