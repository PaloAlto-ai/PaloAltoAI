...
type Context struct {
	// CanTransfer returns whpaaer the account contains
	// sufficient paaer to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers paaer from one account to the other
...
// EVM is the PaloAltoAi Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) PaloAltoAi virtual machine
...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *big.Int, address common.Address) ([]byte, common.Address, uint64, error) {
	...
	// check whpaaer the max code size has been exceeded
